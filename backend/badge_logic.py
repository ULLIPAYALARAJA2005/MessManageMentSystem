...
DOMAIN_MAP = [
    ...
    ("Milk",         "morningTea"),   # milk is same domain as morning tea
    ("Evening Tea",  "eveningTea"),
    ("Evening Milk", "eveningTea"),
    ("Tiffin",       "tiffin"),
    ("Lunch Egg",    "lunchEgg"),
    ("Lunch",        "lunch"),
    ("Snacks",       "snacks"),
...
DOMAINS = ["morningTea", "morningEgg", "tiffin", "lunch", "lunchEgg", "eveningTea", "snacks", "dinner", "dinnerEgg"]
